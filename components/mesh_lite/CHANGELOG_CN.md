...
- 修复当不同节点 max_level 设置不一致时，已经达到最高层级的设备仍有可能被作为父节点进行连接的问题 ([25473c8](https://glab.espressif.cn/solutions/esp-mesh-lite/esp-mesh-lite/-/commit/25473c8c67554704b9f11d0f814a8618c5f17eb3))

### Enhancements:

- 优化 patch 流程，对 patch 进行更精确的管理 ([b811d9c](https://glab.espressif.cn/solutions/esp-mesh-lite/esp-mesh-lite/-/commit/b811d9c3564ba08455dd938892e8b21b2b726184))
...
- 优化 Station 断开后，mesh lite 内部的扫描时间 ([f1343a0b](https://github.com/espressif/esp-mesh-lite/commit/f1343a0b9b8a72fee5cd106c173ea4cc03ac3dbb))
...
- 修复调用 esp_mesh_lite_disconnect 后，偶现仍触发 Wi-Fi 重连的问题 ([f1343a0b](https://github.com/espressif/esp-mesh-lite/commit/f1343a0b9b8a72fee5cd106c173ea4cc03ac3dbb))
